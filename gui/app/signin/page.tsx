  ...
  const handleSignInStep1 = async (e: React.FormEvent) => {
    ...
    try {
      const response = await fetch(
        "http://localhost:5000/api/auth/signin-step1",
        {
          method: "POST",
        ...
        <div className="flex items-center justify-center min-h-[calc(100vh-120px)] px-6">
          <div className="max-w-6xl w-full grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="text-center lg:text-left">
              ...
              <h1 className="text-4xl font-bold text-[#0C5776] mb-4">
                Welcome back to
              </h1>
              <h2 className="text-4xl font-bold text-[#0C5776] mb-6">
                CryptoAuthSystem!
              </h2>

              <p className="text-[#2D99AE] mb-4">
                Sign in to securely access your account and encrypted files.
                Your data stays safe with multi-factor authentication.
              </p>
              ...
              <div className="bg-white p-8 rounded-lg border-2 border-[#2D99AE] shadow-sm">
                ...
                <form className="space-y-4" onSubmit={handleSignInStep1}>
                  ...
                  <p className="text-center text-sm text-gray-600">
                    ...
                    <Link
                      href="/signup"
                      className="text-[#0C5776] hover:underline"
                    >
                      Sign up
                    </Link>
                  </p>
