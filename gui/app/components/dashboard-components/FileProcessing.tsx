...
const FileProcessing = () => {
    ...
    return (
        <div className="p-6 bg-white rounded-lg shadow-md">
            <div className="pt-8">
                <h3 className="text-xl font-semibold text-[#001C44] mb-3">🧪 Split and Encode Big File (Feature 12 Demonstration)</h3>
                <p className="text-gray-700 mb-4">This scenario demonstrates Feature 12. It will take a large file (>5MB), encrypt it in chunks, and provide both the encrypted and decrypted files for verification.</p>
