...
exports.generateKeys = async (req, res) => {
    try {
        ...
        // 1. KIỂM TRA XEM USER ĐÃ CÓ KHÓA CHƯA
        ...
        // 2. Mã hóa Private Key bằng AES
        const { encryptedData, salt, iv } = encryptPrivateKey(privateKey, passphrase);

        // 3. Đặt hạn dùng 90 ngày
        const now = new Date();
